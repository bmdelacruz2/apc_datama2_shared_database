...
CREATE TABLE bmdelacruz2.clients (
...
CREATE TABLE bmdelacruz2.companies (
    id serial CONSTRAINT companies_pk PRIMARY KEY,
    name varchar(100) NOT NULL,
    found_date date NOT NULL,
    president_id int NOT NULL,
    FOREIGN KEY (president_id) REFERENCES bmdelacruz2.presidents (id)
);

CREATE TABLE bmdelacruz2.employee_types (
    id serial CONSTRAINT employee_types_pk PRIMARY KEY,
    type varchar(20) NOT NULL,
    UNIQUE (type)
);

CREATE TABLE bmdelacruz2.employees (
    ...
    FOREIGN KEY (employee_type_id) REFERENCES bmdelacruz2.employee_types (id),
    UNIQUE (contact_number)
);

CREATE TABLE bmdelacruz2.florists (
    id serial CONSTRAINT florists_pk PRIMARY KEY,
    employee_id int NOT NULL,
    flower_variety_qty int NOT NULL,
    FOREIGN KEY (employee_id) REFERENCES bmdelacruz2.employees (id)
);

CREATE TABLE bmdelacruz2.drapers (
...
CREATE TYPE bmdelacruz2.license_types_enum
AS ENUM ('Non-Professional', 'Professional');

CREATE TABLE bmdelacruz2.license_types (
    id serial CONSTRAINT license_types_pk PRIMARY KEY,
    type bmdelacruz2.license_types_enum NOT NULL,
    UNIQUE (type)
);

CREATE TABLE bmdelacruz2.drivers (
    ...
    FOREIGN KEY (employee_id) REFERENCES bmdelacruz2.employees (id),
    FOREIGN KEY (license_type_id) REFERENCES bmdelacruz2.license_types (id),
    UNIQUE (license_num)
);

CREATE TABLE bmdelacruz2.resource_organizers (
...
CREATE TABLE bmdelacruz2.styling_assistants (
...
CREATE TABLE bmdelacruz2.event_types (
    id serial CONSTRAINT event_types_pk PRIMARY KEY,
    type varchar(50) NOT NULL,
    UNIQUE (type)
);

CREATE TABLE bmdelacruz2.events (
    ...
    FOREIGN KEY (company_id) REFERENCES bmdelacruz2.companies (id),
    FOREIGN KEY (event_type_id) REFERENCES bmdelacruz2.event_types (id),
    FOREIGN KEY (client_id) REFERENCES bmdelacruz2.clients (id)
);

CREATE TYPE bmdelacruz2.warehouse_types_enum
AS ENUM ('Public', 'Private', 'Rental');

CREATE TABLE bmdelacruz2.warehouse_types (
    id serial CONSTRAINT warehouse_types_pk PRIMARY KEY,
    type bmdelacruz2.warehouse_types_enum NOT NULL
);

CREATE TABLE bmdelacruz2.warehouses (
...
INSERT INTO bmdelacruz2.presidents (fname, mname, lname, address, contact_number, email_address)
VALUES
...
INSERT INTO bmdelacruz2.clients (fname, mname, lname, contact_number, email_address)
VALUES
...
INSERT INTO bmdelacruz2.companies (name, found_date, president_id)
VALUES
...
INSERT INTO bmdelacruz2.employee_types (type)
VALUES
('drivers'),
('drapers'),
('florists'),
...
INSERT INTO bmdelacruz2.employees (fname, mname, lname, contact_number, address, company_id, employee_type_id)
VALUES
...
INSERT INTO bmdelacruz2.florists (employee_id, flower_variety_qty)
VALUES
(11, 30),
(12, 40),
(13, 45),
...
INSERT INTO bmdelacruz2.drapers (employee_id, certification_qty, years_experience, exhibit_qty)
VALUES
(6, 2, 5, 10),
(7, 4, 2, 7),
(8, 7, 3, 6),
...
INSERT INTO bmdelacruz2.license_types (type)
VALUES
('Non-Professional'),
('Professional');

INSERT INTO bmdelacruz2.drivers (employee_id, license_num, license_expiry, license_type_id)
VALUES
...
INSERT INTO bmdelacruz2.resource_organizers (employee_id, years_experience, description)
VALUES
(21, 5, 'Self-motivated'),
...
INSERT INTO bmdelacruz2.styling_assistants (employee_id, certification_qty, years_experience, specialization)
VALUES
...
INSERT INTO bmdelacruz2.event_types (type)
VALUES
('Wedding'),
('Birthday'),
('Christening'),
...
INSERT INTO bmdelacruz2.events (company_id, event_type_id, client_id, location, startdate, enddate)
VALUES
...
INSERT INTO bmdelacruz2.warehouse_types (type)
VALUES
('Public'),
('Private'),
('Rental');

INSERT INTO bmdelacruz2.warehouses (company_id, warehouse_type_id, location)
VALUES
